<template>
<div class="container noselect" @click="handleCardClick">
  <div class="canvas">
    ...
    <div id="card">
      <div class="card-content">
        ...
        <p id="prompt">{{ title }}</p>
        <div class="title">EXPLORE<br />MORE</div>
        ...
        <div class="subtitle">
          <span>Click</span>
          <span class="highlight">to view more</span>
        </div>
...
const handleCardClick = () => {
    router.push({ name: props.route, query: props.query })
}
</script>
